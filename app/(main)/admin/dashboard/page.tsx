  ...
  return (
    <div className="animate-pulse rounded-2xl border border-[#1e2530] bg-surface-secondary p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="h-3 w-24 bg-surface-skeleton rounded-lg" />
        <div className="w-9 h-9 bg-surface-skeleton rounded-xl" />
      </div>
      <div className="h-8 w-16 bg-surface-skeleton rounded-lg mb-2" />
      <div className="h-3 w-28 bg-surface-skeleton rounded-lg" />
    </div>
  );
}
...
function StatCard({
  ...
  return (
    <Link
      href={href}
      className="group relative flex flex-col rounded-2xl border border-[#1e2530] bg-surface-secondary p-6 hover:border-[#00E5FF33] transition-all duration-300 overflow-hidden"
    >
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div
          className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-300 ${accent
            ...
            : "bg-overlay-hover border border-[#1e2530] text-content-muted group-hover:text-[#00E5FF] group-hover:border-[#00E5FF30]"
            }`}
        >
          <Icon size={16} />
        </div>
      ...
      <div
        className={`text-4xl font-black tracking-tight mb-1 transition-colors duration-300 ${accent ? "text-[#00E5FF]" : "text-content-default group-hover:text-[#eee]"
          }`}
      >
        {value}
      </div>
...
function CreateEventModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg rounded-2xl border border-[#1e2530] bg-surface-card-alt shadow-2xl"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-[#1e2530]">
          <div>
            <h2 className="text-lg font-black text-content-default tracking-tight">{t("createEventModal.title")}</h2>
            <p className="text-xs text-content-muted mt-0.5">{t("createEventModal.description")}</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 flex flex-col gap-4">
          <div>
            <label className="block text-xs font-semibold uppercase tracking-widest text-content-muted mb-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-surface-secondary border border-[#1e2530] text-sm text-content-default placeholder-content-muted focus:outline-none focus:border-[#00E5FF44] focus:ring-1 focus:ring-[#00E5FF22] transition-all"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 rounded-xl bg-surface-secondary border border-[#1e2530] text-sm text-content-default placeholder-content-muted focus:outline-none focus:border-[#00E5FF44] focus:ring-1 focus:ring-[#00E5FF22] transition-all resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-surface-secondary border border-[#1e2530] text-sm text-content-default focus:outline-none focus:border-[#00E5FF44] focus:ring-1 focus:ring-[#00E5FF22] transition-all"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold uppercase tracking-widest text-content-muted mb-1.5">
...
function EventCard({
  ...
  return (
    <Link
      ...
      className="group flex items-center gap-4 p-4 rounded-xl border border-[#1e2530] bg-surface-card-alt hover:border-[#00E5FF33] hover:bg-[#00E5FF05] transition-all duration-200"
    >
      {/* Date badge */}
      <div className="shrink-0 flex flex-col items-center justify-center w-11 h-11 rounded-xl bg-surface-skeleton text-center">
        <span className="text-[10px] font-bold uppercase tracking-widest text-content-muted leading-none">
          {start.toLocaleDateString("fr-FR", { month: "short" })}
        </span>
        <span className="text-base font-black text-content-default leading-tight">
          {start.getDate()}
        </span>
      </div>
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-bold text-content-default truncate group-hover:text-[#00E5FF] transition-colors">
          {event.title}
        </p>
        <div className="flex items-center gap-2 mt-0.5 flex-wrap">
          {event.location && (
            <span className="flex items-center gap-1 text-[10px] text-content-muted font-semibold">
      ...
      <div className="shrink-0">
        {isLive ? (
          ...
          <span className="px-2 py-0.5 rounded-full bg-surface-skeleton text-[10px] font-bold text-content-muted">
              {t("ended")}
          </span>
        ) : (
      ...
      <ChevronRight size={14} className="shrink-0 text-content-muted group-hover:text-[#00E5FF] transition-colors" />
    </Link>
  );
}
      ...
      <main className="flex-1 px-8 py-12 max-w-6xl mx-auto w-full">
        {/* Breadcrumb */}
          <div className="flex items-center gap-2 text-sm text-content-secondary mb-8">
            ...
            <span className="text-content-default">{t("breadcrumbDashboard")}</span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-10">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-3xl font-black text-content-default tracking-tight">{t("pageTitle")}</h1>
            </div>
            <p className="text-sm text-content-secondary ml-11">{t("pageDescription")}</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
          ...
          {/* Events list — 3 cols */}
          <div className="lg:col-span-3 rounded-2xl border border-[#1e2530] bg-surface-secondary overflow-hidden flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#1e2530] shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-black text-content-default tracking-tight">{t("recentEventsTitle")}</h2>
              </div>
              <Link
                href="/admin/events"
            ...
            <div className="flex-1 flex flex-col p-4 gap-2">
              ...
              {loading &&
                Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="animate-pulse flex items-center gap-4 p-4 rounded-xl border border-[#1e2530]">
                    <div className="w-11 h-11 rounded-xl bg-surface-skeleton shrink-0" />
                    <div className="flex-1 space-y-2">
                      <div className="h-3 w-3/4 bg-surface-skeleton rounded-lg" />
                      <div className="h-2.5 w-1/2 bg-surface-skeleton rounded-lg" />
                    </div>
                    <div className="w-14 h-5 bg-surface-skeleton rounded-full shrink-0" />
                  </div>
                ))}
              ...
              {!loading && (!stats?.recentEvents || stats.recentEvents.length === 0) && (
                <div className="flex-1 flex flex-col items-center justify-center py-10">
                  <Calendar size={28} className="text-content-muted mb-3" />
                  <p className="text-content-muted italic text-sm">{t("noRecentEvents")}</p>
                </div>
              )}
          ...
          <div className="lg:col-span-2 rounded-2xl border border-[#1e2530] bg-surface-secondary overflow-hidden flex flex-col">
            <div className="flex items-center gap-2 px-6 py-4 border-b border-[#1e2530] shrink-0">
              <Zap size={15} className="text-[#00E5FF]" />
              <h2 className="text-sm font-black text-content-default tracking-tight">{t("quickActions.title")}</h2>
            </div>
            ...
            <div className="flex-1 flex flex-col p-4 gap-3">
              {quickActions.map((action) => (
                <Link
                  ...
                  className={`group flex items-center gap-4 p-4 rounded-xl border transition-all duration-200 ${action.accent
                    ...
                    : "border-[#1e2530] bg-surface-card-alt hover:border-[#00E5FF33] hover:bg-[#00E5FF05]"
                    }`}
                >
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-all duration-200 ${action.accent
                      ...
                      : "bg-surface-skeleton border border-content-muted text-content-muted group-hover:text-[#00E5FF] group-hover:border-[#00E5FF33]"
                      }`}
                  >
                    <action.icon size={16} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p
                      className={`text-sm font-bold transition-colors duration-200 ${action.accent
                        ? "text-[#00E5FF]"
                        : "text-content-default group-hover:text-[#00E5FF]"
                        }`}
                    >
                      {action.label}
                    </p>
                    <p className="text-[10px] text-content-muted font-semibold mt-0.5">
                      {action.description}
                    </p>
                  </div>
                  <ChevronRight
                    size={15}
                    className={`shrink-0 transition-colors duration-200 ${action.accent ? "text-[#00E5FF80]" : "text-content-muted group-hover:text-[#00E5FF]"
                      }`}
                  />
                </Link>
              ))}
              ...
              <div className="flex-1 mt-2 rounded-xl border border-dashed border-[#1e2530] flex flex-col items-center justify-center gap-2 p-6 text-center">
                <div className="w-9 h-9 rounded-xl bg-surface-skeleton flex items-center justify-center">
                  <TrendingUp size={15} className="text-content-muted" />
                </div>
          ...
          <div className="divide-y divide-[#1e2530]">
            {loading &&
              Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="px-6 py-4 animate-pulse flex gap-3">
                  <div className="w-2 h-2 rounded-full bg-surface-skeleton mt-1.5 shrink-0" />
                  <div className="flex-1 space-y-2">
            ...
            {!loading && (!stats || stats.recentQuestions.length === 0) && (
              <div className="px-6 py-12 text-center">
                <MessageSquare size={24} className="mx-auto text-content-muted mb-3" />
                <p className="text-content-muted italic text-sm">{t("noQuestions")}</p>
              </div>
            )}
            ...
            {!loading &&
              stats?.recentQuestions.slice(0, 5).map((q) => (
                <div key={q.id} className="px-6 py-4 group hover:bg-overlay-hover transition-colors">
                  <p className="text-sm text-content-default leading-relaxed mb-1.5">{q.content}</p>
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full border border-[#1e2530] text-content-muted font-semibold">
                      📍 {q.session.event.title}
                    </span>
                    <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full border border-[#1e2530] text-content-muted font-semibold">
                      🎙️ {q.session.title}
                    </span>
                    <span className="text-[10px] text-content-muted ml-auto font-semibold">
