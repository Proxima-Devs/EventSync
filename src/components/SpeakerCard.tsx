  ...
  return (
    <div className="relative mt-27">
      ...
      <motion.div
        ...
        className="group relative flex flex-col rounded-2xl border border-[#1e2530] bg-[#0d1117] overflow-hidden hover:border-[#00E5FF30] transition-all duration-300"
        style={{
      ...
      >
        ...
        {/* Action bar */}
        <div className="flex items-center gap-2 px-4 py-3 border-t border-[#1e2530] bg-[#060a0f]">
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
